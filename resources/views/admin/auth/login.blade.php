            ...
            <form class="col-lg-3 col-md-4 col-10 mx-auto text-center" method="POST" action="{{ route('admin.login') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" :value="old('email')" id="inputEmail"
                        class="form-control form-control-lg" placeholder="{{__('keywords.email')}}" autofocus="">
                </div>
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit"> {{ __('keywords.sign_in') }} </button>
