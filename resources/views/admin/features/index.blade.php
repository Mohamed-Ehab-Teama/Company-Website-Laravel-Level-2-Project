        ...
        <div class="col-12">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <div class="page-title-right">
                    ...
                    <x-action-button-component href="{{ route('admin.features.create') }}" type="create"></x-action-button-component>
                </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td> {{ $feature->name }} </td>
                        <td>
                            <i class="{{ $feature->icon }} fe-16"></i>
                        </td>
                        <td>

                            <!-- Show -->
                            <x-action-button-component href=" {{ route('admin.features.show', ['feature' => $feature]) }} " type="show" ></x-action-button-component>
                            ...
                            <!-- Edit -->
                            <x-action-button-component href=" {{ route('admin.features.edit', ['feature' => $feature]) }} " type="edit" ></x-action-button-component>
                            ...
                            <!-- Delete -->
                            <x-delete-button-component href="{{ route('admin.features.destroy', ['feature' => $feature]) }}" id="{{ $feature->id }}" ></x-delete-button-component>
